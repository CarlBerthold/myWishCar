    ...
    return (
        <div>
            ...
            <div class="carousel-item active">
              <img src="Startpic.jpg" class="d-block w-100" alt="Startpic" />
            </div>
            <div class="carousel-item">
              <img src="Street.jpg" class="d-block w-100" alt="Street" />
            </div>
            <div class="carousel-item">
              <img src="Street2.jpg" class="d-block w-100" alt="Street2" />
            </div>
            </div>
