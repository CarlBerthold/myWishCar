...
export default function LandingPage() {
    return (
        <div>
            <h1>Welcome on my Wish Car</h1>
            <img src="Startpic.jpg" width="800px" height="500px"/>
            <p>Hallo. Ich bin ein kleiner Blindtext. 
                Und zwar schon so lange ich denken kann. 
                Es war nicht leicht zu verstehen, was es bedeutet, ein blinder Text zu sein: Man ergibt keinen Sinn. 
