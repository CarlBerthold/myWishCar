    ...
    return (
        <div>
            ...
            <div classNameName="carousel-item active">
              <img src="Startpic.jpg" className="d-block w-100" alt="Startpic" />
            </div>
            <div className="carousel-item">
              <img src="Street.jpg" className="d-block w-100" alt="Street" />
            </div>
            <div className="carousel-item">
              <img src="Street2.jpg" className="d-block w-100" alt="Street2" />
            </div>
            </div>
